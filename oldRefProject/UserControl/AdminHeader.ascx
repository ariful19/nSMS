...
<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-lg"><b>Bidyapith</b></span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <asp:Image ID="imgtopProfile" runat="server" CssClass="img-circle" Height="15" Width="15" />
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <asp:Image ID="imgHeaderProfile" runat="server" CssClass="img-circle" />
                        ...
                        <li class="user-body">
                            <div class="row">
                                <div class="col-sm-12 text-center" style="color: white;">
                                    <a href="../../Pages/RoleManagement/ChangePassword.aspx" class="btn btn-block btn-default btn-flat">Change Password</a>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="../../Pages/User/Profile.aspx" class="btn btn-info btn-flat">Profile</a>
                            </div>
                            <div class="pull-right">
                                <asp:LoginStatus ID="LoginStatus1" runat="server" LoginText="Login" OnLoggedOut="LoginStatus1_LoggedOut" CssClass="btn btn-default btn-flat"
                                    ForeColor="Black" />
                            </div>
                        </li>
                    </ul>
