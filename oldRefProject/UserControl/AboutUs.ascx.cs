...
public partial class UserControl_AboutUs : System.Web.UI.UserControl
{
    ...
    protected void LoadDataBangla()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblDesignation.Text = dt.Rows[0]["AboutUsbangla"].ToString();
    ...
    protected void LoadDataEnglish()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblDesignation.Text = dt.Rows[0]["AboutUsEnglish"].ToString();
