...
public partial class Report_AccountViewer_RptRecieveable : System.Web.UI.Page
{
    ...
    protected string GetCriteria()
    {
        ...
        if (tbxAccountId.Text != "")
        {
            if (criteria == "")
            {
                criteria = "AccountCodeId='" + tbxAccountId.Text + "'";
                Session["rptAccountCodeId"] = tbxAccountId.Text;                
            }
            else
            {
                Session["rptAccountCodeId"] = tbxAccountId.Text;
                criteria += " and AccountCodeId='" + tbxAccountId.Text + "'";
            }
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../../Report/AccountViewer/AccountReportView.aspx?query=" + EncryptionDecryption.EncryptDecryptString(GetCriteria()) + "&report=recieveable");
    }
}
