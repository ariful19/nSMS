...
public partial class Report_AccountViewer_RptStatement : System.Web.UI.Page
{
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../../Report/AccountViewer/AccountReportView.aspx?query=" + EncryptionDecryption.EncryptDecryptString(GetCriteria()) + "&report=statement");
    }
}
