<%@ Page Title="<%$ Resources:Application,LedgerReports %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="RptLedger.aspx.cs" Inherits="Report_AccountViewer_RptLedger" %>
