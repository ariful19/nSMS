<%@ Page Title="<%$ Resources:Application,StudentsDetailReport %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="StudentDetails.aspx.cs" Inherits="Report_Viewer_StudentDetails" %>
    ...
    <div class='<%= Common.SessionInfo.Panel %>' id="criteria">
        ...
        <div class="panel-footer">
            <asp:Button ID="btnViewStudent" runat="server" CssClass="btn btn-flat btn-success"
                Text="Student Information Report" OnClick="btnViewStudent_Click" />
        </div>
    </div>
</asp:Content>
