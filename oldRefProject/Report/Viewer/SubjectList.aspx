<%@ Page Title="<%$ Resources:Application,SubjectList %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SubjectList.aspx.cs" Inherits="Report_Viewer_SubjectList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
        ...
        <div class="col-sm-12">
            <div class="padding-bottom-15">
                <asp:RadioButtonList ID="rdList" runat="server" ClientIDMode="Static" RepeatColumns="2" CssClass="form-control FormatRadioButtonList">
                    <asp:ListItem Value="1" Text="<%$ Resources:Application,SubjectList %>"></asp:ListItem>
                    <asp:ListItem Value="2" Text="Optional & Compolsery SubjectList"></asp:ListItem>                    
                </asp:RadioButtonList>
            </div>
        </div>
    </div>
    <div class='<%= Common.SessionInfo.Panel %>'>
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6 col-md-6">
                   <div class="form-horizontal" id="optional">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4">
