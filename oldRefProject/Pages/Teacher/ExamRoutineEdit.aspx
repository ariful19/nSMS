<%@ Page Title="<%$ Resources:Application,ExamRoutineEdit %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ExamRoutineEdit.aspx.cs" Inherits="Pages_Teacher_ExamRoutineView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    ErrorMessage="Invalid Date." ValidationGroup="Group2" />
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="fa fa-2x fa-trash-o"
                                        OnClick="LinkButton1_Click" OnClientClick="if ( ! DeleteConfirmation()) return false;"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
        ...
        <div class="panel-footer">
            <asp:Button ID="ButtonAdd" runat="server" CssClass="btn btn-flat btn-success pull-left" Text="Create New Routine" OnClick="btnBack_Click"/>
