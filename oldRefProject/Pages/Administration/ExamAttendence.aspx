<%@ Page Title=" <%$ Resources:Application,ExamAttendenceSetup %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ExamAttendence.aspx.cs" Inherits="Pages_Administration_ExamAttendence" %>
  ...
  <asp:Panel ID="pnlSMS" runat="server" ClientIDMode="Static">
    ...
    <asp:Panel ClientIDMode="Static" ID="pnlAssignStudent" runat="server">
        <div class='<%= Common.SessionInfo.Panel %>'>
            ...
            <div class="panel-body">
                <asp:Repeater ID="rptStudent" runat="server" OnItemDataBound="rptStudentRoll_ItemDataBound">
                    <HeaderTemplate>
