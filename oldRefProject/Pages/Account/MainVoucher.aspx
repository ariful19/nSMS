<%@ Page Title="<%$ Resources:Application,MainVoucher %>"  Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="MainVoucher.aspx.cs" Inherits="Pages_Account_MainVoucher" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,VoucherCodeId %>"></asp:Label><span class="required">*</span></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxVoucherCode" runat="server" placeholder="Enter Voucher Code" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator2" runat="server" ValidationGroup="save"
                            ErrorMessage="Enter Voucher Code" ControlToValidate="tbxVoucherCode">*</asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Application,VoucherName %>"></asp:Label><span class="required">*</span></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxVoucherName" runat="server" placeholder="Enter Voucher Name" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator1" runat="server" ValidationGroup="save"
                            ErrorMessage="Enter Voucher Name" ControlToValidate="tbxVoucherName">*</asp:RequiredFieldValidator>
                    </div>
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <div class="box">
                            <div class="box-body">
                                <asp:Repeater ID="rptMainVoucher" runat="server">
                                    <HeaderTemplate>
                                        <table id="example1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Application,VoucherCodeId %>"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Application,VoucherName %>"></asp:Label>
                                                    </th>
                                                   <%-- <th class="action">
