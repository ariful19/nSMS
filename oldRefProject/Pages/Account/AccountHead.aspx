<%@ Page Title="<%$ Resources:Application,AccountHead %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="AccountHead.aspx.cs" Inherits="Pages_Account_AccountHead" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:Application,MainCodeId %>"></asp:Label></label>
                    <div class="col-sm-3">
                         <asp:DropDownList ID="ddlMainCode" runat="server" DataTextField="MainCodeId" DataValueField="Id" CssClass="form-control dropdown"></asp:DropDownList>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,AccountCodeId %>"></asp:Label><span class="required">*</span></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxHeadCode" runat="server" placeholder="Enter Account Head Code" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator2" runat="server" ValidationGroup="save"
                            ErrorMessage="Enter Account Head Code" ControlToValidate="tbxHeadCode">*</asp:RequiredFieldValidator>
                    </div>
                </div>
                 <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Application,AccountCodeName %>"></asp:Label><span class="required">*</span></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxCodeName" runat="server" placeholder="Enter Account Code Name" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator1" runat="server" ValidationGroup="save"
                            ErrorMessage="Enter Account Code Name" ControlToValidate="tbxCodeName">*</asp:RequiredFieldValidator>
                    </div>
                </div>
                 <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                                        ...
                                        <table id="example1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                     ...
                                                     <th>
                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:Application,HeadCodeId %>"></asp:Label></th>
                                                    <th>
                                                   ...
                                                   <th>
                                                     ...
                                                     <th>
                                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:Application,AId %>"></asp:Label></th>
                                                    <th>
