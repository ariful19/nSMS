<%@ Page Title="<%$ Resources:Application,ExpenseCategory %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ExpenseCategory.aspx.cs" Inherits="Pages_Account_ExpenseCategory" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,ExpenseCategory %>"></asp:Label></label>
                    <div class="col-sm-3">
