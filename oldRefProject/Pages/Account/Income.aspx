<%@ Page Title="<%$ Resources:Application,Income %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Income.aspx.cs" Inherits="Pages_Account_Income" %>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3">
                                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Application,IncomeCategory %>"></asp:Label></label>
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <asp:DropDownList ID="ddlIncome" runat="server" DataValueField="Id" DataTextField="IncomeCategory" CssClass="form-control"></asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <p class="help-block">Note: only .jpg, png,.pdf are allowed.</p>
                            </div>
                        </div>
                        <div class="form-group">
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Application,IncomeCategory %>"></asp:Label></th>
                                                <th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3">
                                    <asp:Label ID="Label11" runat="server" Text="<%$ Resources:Application,IncomeCategory %>"></asp:Label></label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="tbxName" runat="server" placeholder="Enter Income Category" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator1" runat="server" ValidationGroup="add"
                                        ErrorMessage="Enter Income Category" ControlToValidate="tbxName">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </div>
