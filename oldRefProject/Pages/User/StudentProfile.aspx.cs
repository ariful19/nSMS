...
public partial class Pages_User_StudentProfile : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.User.IsInRole("Admin"))
        {
            ...
            btnOtherInfoEdit.Visible = false;
            presentAddEditDiv.Visible = false;
            permanentAddEditDiv.Visible = false;
            localGuardianAddEditDiv.Visible = false;
            motherAddEditDiv.Visible = false;
            fatherAddEditDiv.Visible = false;
            personalAddEditDiv.Visible = false;
            personPhotoChangeDiv.Visible = false;
            fatherImage.Visible = false;
            motherImage.Visible = false;
            academicInfoDiv.Visible = true;
        }
        if (!IsPostBack)
        {
            ...
            if (Page.User.Identity.Name != "")
            {
                if (Request.QueryString["UserName"] != null)
                {
                    if (Page.User.IsInRole("Admin"))
                    {
                        ...
                        studentId = Controller.StudentIdByPersonalId(ID);
                    }
                }
                else
                {
