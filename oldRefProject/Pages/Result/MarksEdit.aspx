            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <asp:DropDownList ID="ddlMarksOutOf" DataTextField="OutOfMarks" DataValueField="Id" runat="server" CssClass="form-control dropdown">
                                        ...
                                        <table id="example1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <asp:Label ID="Label17" runat="server" Text="WeeklyMarks"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label16" runat="server" Text="<%$ Resources:Application,MonthlyMarks %>"></asp:Label></th>
                                                    <th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:HiddenField ID="hdnIsFinished" Value='<%#Eval("IsFinishMarks") %>' runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="attendanceTextBox" runat="server" CssClass="form-control" Width="100%" Text='<%#Eval("AttendanceMarks") %>' MaxLength="6"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredtbxRoll" runat="server"
                                                    Enabled="True" TargetControlID="attendanceTextBox" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="monthlyMarksTextBox" runat="server" CssClass="form-control" Text='<%#Eval("MonthlyMarks") %>' Width="100%" MaxLength="6"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True" TargetControlID="monthlyMarksTextBox" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="tbxTheory" runat="server" Width="100%" CssClass="form-control" Text='<%#Eval("SubjectiveMarks") %>' MaxLength="6"></asp:TextBox>
<%--                                                <asp:RegularExpressionValidator runat="server" ID="validateMarks" ControlToValidate="tbxTheory" ValidationExpression="^([0-9]{1,2}){1}(\.[0-9]{1,2})?$|^100$"
                                                    ErrorMessage="Please enter valid number!" />--%>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
                                                    Enabled="True" TargetControlID="tbxTheory" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="tbxObjective" runat="server" Width="100%" CssClass="form-control" Text='<%#Eval("ObjectiveMarks") %>' MaxLength="6"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                                                    Enabled="True" TargetControlID="tbxObjective" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="tbxPractical" runat="server" Width="100%" CssClass="form-control" Text='<%#Eval("PracticalMarks") %>' MaxLength="6"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server"
                                                    Enabled="True" TargetControlID="tbxPractical" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>

                                            </td>
                                         <%--   <td>
                                                <asp:TextBox ID="tbxSBS" runat="server" Width="100%" CssClass="form-control" Text='<%#Eval("OtherMarks") %>' MaxLength="6"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server"
                                                    Enabled="True" TargetControlID="tbxSBS" FilterType="Custom" ValidChars="0123456789."></cc1:FilteredTextBoxExtender>
                                            </td>--%>
