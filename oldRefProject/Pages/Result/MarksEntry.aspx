            ...
            <asp:Panel ClientIDMode="Static" ID="pnlAssignStudent" runat="server">
                <div class='<%= Common.SessionInfo.Panel %>'>
                                ...
                                <asp:Repeater ID="rptStudent" runat="server" OnItemDataBound="rptStudent_ItemDataBound">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblReg" Text='<%#Eval("RegNo") %>' runat="server"/>
                                            ...
                                            <td>
                                                <asp:TextBox ID="attendanceTextBox" runat="server" Width="100%" CssClass="form-control" MaxLength="6"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredAttendanceTextBox" runat="server"
                                                    Enabled="True" TargetControlID="attendanceTextBox" FilterType="Custom" ValidChars="0123456789.">
                                                </cc1:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="mothlyTextBox" runat="server" Width="100%" CssClass="form-control" MaxLength="6"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtendermothly" runat="server"
                                                    Enabled="True" TargetControlID="mothlyTextBox" FilterType="Custom" ValidChars="0123456789.">
                                                </cc1:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="tbxTheory" runat="server" Width="100%" CssClass="form-control" MaxLength="6"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtenderTheory" runat="server"
                                                    Enabled="True" TargetControlID="tbxTheory" FilterType="Custom" ValidChars="0123456789.">
                                                </cc1:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="tbxObjective" runat="server" Width="100%" CssClass="form-control" MaxLength="6"></asp:TextBox>                   
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtenderObjective" runat="server"
                                                    Enabled="True" TargetControlID="tbxObjective" FilterType="Custom" ValidChars="0123456789.">
                                                </cc1:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="tbxPractical" runat="server" Width="100%" CssClass="form-control" MaxLength="6"></asp:TextBox>
                                                <%--<asp:RegularExpressionValidator runat="server" ID="RegularExpressionValidator2" ControlToValidate="tbxPractical" ValidationExpression="^([0-9]{1,2}){1}(\.[0-9]{1,2})?$|^100$"
                                                    ErrorMessage="Please enter valid number!" />--%>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtenderPractical" runat="server"
                                                    Enabled="True" TargetControlID="tbxPractical" FilterType="Custom" ValidChars="0123456789.">
                                                </cc1:FilteredTextBoxExtender>
                                            </td>
                                           <%-- <td>
                                                <asp:TextBox ID="tbxSBS" runat="server" Width="100%" CssClass="form-control" MaxLength="6"></asp:TextBox>
                                               <%-- <asp:RegularExpressionValidator runat="server" ID="RegularExpressionValidator3" ControlToValidate="tbxSBS" ValidationExpression="^([0-9]{1,2}){1}(\.[0-9]{1,2})?$|^100$"
                                                    ErrorMessage="Please enter valid number!" />--%>
                                               <%-- <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtenderSBS" runat="server"
                                                    Enabled="True" TargetControlID="tbxSBS" FilterType="Custom" ValidChars="0123456789.">
                                                </cc1:FilteredTextBoxExtender>--%>
                                           <%-- </td>--%>
                                        </tr>
                                    </ItemTemplate>
                    ...
                    <div class="panel panel-footer">
                        ...
                        <asp:Button ID="btnBlankReport" runat="server" CssClass="btn btn-primary" OnClick="btnBlankReport_Click" Text="Generate Blank Report" />
