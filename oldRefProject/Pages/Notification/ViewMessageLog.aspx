<%@ Page Title="<%$ Resources:Application,MessageLog %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ViewMessageLog.aspx.cs" Inherits="Pages_Notification_ViewMessageLog" %>
                                ...
                                <asp:Repeater ID="rptMessageLog" runat="server">
                                        ...
                                        <table id="example1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Application,MessageType %>"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Application,SendDate %>"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="lblMobile" runat="server" Text="<%$ Resources:Application,Mobile %>"></asp:Label></th>
                                                    <th>
                                                        <asp:Label ID="lblSender" runat="server" Text="<%$ Resources:Application,SenderName %>"></asp:Label></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Convert.ToDateTime(Eval("SendDate")).ToString("dd/MM/yyyy")%></td>
                                            <asp:HiddenField ID="hdnMessageLogID" Value='<%#Eval("MessageLogID") %>' runat="server" />
