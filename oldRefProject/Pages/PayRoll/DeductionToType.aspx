<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="DeductionToType.aspx.cs" Inherits="Pages_PayRoll_DeductionToType" %>
                    ...
                    <div class="col-sm-offset-2 col-sm-8">
                        <div class='<%= Common.SessionInfo.Panel %>'>
                            <div class="panel-heading">
                                <asp:Label ID="Label3" runat="server" Text="Deduction Type"></asp:Label>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2">
                                            <asp:Label ID="Label2" runat="server" Text="Deduction"></asp:Label></label>
                                        <div class="col-sm-8">
