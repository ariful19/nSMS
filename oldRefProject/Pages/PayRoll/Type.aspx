<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Type.aspx.cs" Inherits="Pages_PayRoll_Type" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                        <asp:Label ID="Label5" runat="server" Text="Type Name"></asp:Label></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxName" runat="server" placeholder="Enter Type Name" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator2" runat="server" ValidationGroup="save"
                            ErrorMessage="Enter Type Name" ControlToValidate="tbxName">*</asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                        <asp:Label ID="Label2" runat="server" Text="Slary Scale"></asp:Label></label>
                    <div class="col-sm-3">
                        <asp:DropDownList ID="ddlScale" runat="server" DataTextField="Scale" DataValueField="Id" CssClass="form-control"></asp:DropDownList>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2">
                        <asp:Label ID="Label3" runat="server" Text="Basic Saraly"></asp:Label></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxBasic" runat="server" placeholder="Enter Basic Saraly" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator3" runat="server" ValidationGroup="save"
                            ErrorMessage="Enter Basic Saraly" ControlToValidate="tbxBasic">*</asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                                    ...
                                    <HeaderTemplate>
                                        <table id="example1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,Group %>"></asp:Label></th>
                                                    <th>
