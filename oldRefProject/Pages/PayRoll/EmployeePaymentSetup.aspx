<%@ Title="EmployeePaymentSetup" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="EmployeePaymentSetup.aspx.cs" Inherits="Pages_PayRoll_EmployeePaymentSetup" %>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4">
                            <asp:Label ID="Label1" runat="server" Text="Grade"></asp:Label></label>
                        <div class="col-sm-8">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-horizontal">                  
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4">
                            <asp:Label ID="Label5" runat="server" Text="Level"></asp:Label></label>
                        <div class="col-sm-8">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="col-sm-9">
                    <div>
                        <div class="panel-heading">
                            <asp:Label ID="Label3" runat="server" Text="Payroll Type"></asp:Label>
                                ...
                                <asp:Repeater ID="rptPaymentType" runat="server">
                                    <HeaderTemplate>
                                        <table id="example12" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <asp:Label ID="lblSalary" runat="server" Text="Payroll Type"></asp:Label></th>
                                                    <th>Amount</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="tbxPayrollType" Text='<%#Eval("Amount") %>' runat="server" paleholder="Enter Payment Amount" CssClass="form-control"></asp:TextBox>
                                                <asp:CompareValidator runat="server" Operator="DataTypeCheck" Type="Currency"
                                                    ControlToValidate="tbxPayrollType" ErrorMessage="Value must be a whole number" />
                                            </td>
                                            <td style="display: none">
                                                <asp:TextBox ID="txtPayrollToDesignationID" Text='<%#Eval("PayrollToDesignationID") %>' runat="server" CssClass="form-control"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <HeaderTemplate>
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>
                                                    <asp:Label ID="Label3" runat="server" Text="Payroll Type"></asp:Label></th>
                                                <th>Amount</th>
                                            </tr>
                                        </thead>
                                        <tbody>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                        ...
                        <h4 class="modal-title">Add New Payroll Type</h4>
                    </div>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3">
                                    <asp:Label ID="Label6" runat="server" Text="Payroll Type"></asp:Label></label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="tbxName" runat="server" placeholder="Enter payroll Type" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator2" runat="server" ValidationGroup="save"
                                        ErrorMessage="Enter Salary Type" ControlToValidate="tbxName">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </div>
