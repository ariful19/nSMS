...
public partial class Pages_Admin_Shift : BasePage
{
    dalShift obj = new dalShift();
    ...
    {
        DataTable dt = new Common().GetAll("bs_Shift");
    ...
    protected void btnEdit_Command(object sender, CommandEventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            tbxName.Text = dt.Rows[0]["Shift"].ToString();
        }
