...
public partial class Pages_Admin_Religion : BasePage
{
    dalReligion obj = new dalReligion();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (ID != -1)
            ...
            MessageController.Show("This Religion name already exists. Please try anothor.", MessageType.Error, Page);
    ...
    {
        DataTable dt = new Common().GetAll("bs_Religion");
    ...
    protected void btnEdit_Command(object sender, CommandEventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            tbxName.Text = dt.Rows[0]["Religion"].ToString();
        }
    ...
    {
        ID = Convert.ToInt32(e.CommandArgument);
        new Common().Delete("bs_Religion", ID);
