<%@ Page Title="<%$ Resources:Application,DailyOrWeeklyMarksSetup %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="DailyOrWeeklyMarksSetup.aspx.cs" Inherits="Pages_Admin_DailyOrWeeklyMarksSetup" %>
   ...
   <asp:UpdatePanel ID="Updatepanel1" runat="server">
        <ContentTemplate>
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2"><asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,DailyOrWeeklyMarks %>"></asp:Label></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxDailyMark" runat="server" placeholder="Enter Marks" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator Display="None" ID="RequiredFieldValidator2" runat="server" ValidationGroup="save"
                            ErrorMessage="Enter Marks" ControlToValidate="tbxDailyMark">*</asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                                ...
                                <asp:Repeater ID="rptYear" runat="server">
                                    <HeaderTemplate>
                                        <table id="example1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th><asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,DailyOrWeeklyMarks %>"></asp:Label></th>
