...
public partial class Pages_Admin_Status : System.Web.UI.Page
{
    dalStatus obj=new dalStatus();
    ...
    {
        DataTable dt = new Common().GetAll("bs_Status");
    ...
    protected void btnEdit_Command(object sender, CommandEventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            tbxName.Text = dt.Rows[0]["Status"].ToString();
        }
    ...
    {
        ID = Convert.ToInt32(e.CommandArgument);
        new Common().Delete("bs_Status", ID);
