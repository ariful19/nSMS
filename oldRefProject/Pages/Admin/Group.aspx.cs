...
public partial class Pages_Admin_Group : BasePage
{
    dalGroup obj = new dalGroup();
    ...
    {
        DataTable dt = new Common().GetAll("bs_Group");
    ...
    protected void btnEdit_Command(object sender, CommandEventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            tbxName.Text = dt.Rows[0]["GroupName"].ToString();
        }
