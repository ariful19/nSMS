...
public partial class Pages_Admin_Gender : BasePage
{
    dalGender obj = new dalGender();
    ...
    {
        DataTable dt = new Common().GetAll("bs_Gender");
    ...
    protected void btnEdit_Command(object sender, CommandEventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            tbxName.Text = dt.Rows[0]["Gender"].ToString();
        }
