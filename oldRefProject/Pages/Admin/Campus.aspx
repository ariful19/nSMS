<%@ Page Title="<%$ Resources:Application,CampusSetup %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Campus.aspx.cs" Inherits="Pages_Admin_Campus" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-1">
                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,Campus %>"></asp:Label></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxName" runat="server" placeholder="Enter Campus" CssClass="form-control"></asp:TextBox>
                                        ...
                                        <table id="example1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Application,Campus %>"></asp:Label></th>
                                                    <th class="action">
