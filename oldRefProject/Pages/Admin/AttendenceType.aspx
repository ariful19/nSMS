<%@ Page Title="<%$ Resources:Application,AttendenceTypeSetup %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="AttendenceType.aspx.cs" Inherits="Pages_Admin_AttendenceType" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-1">
                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Application,AttendenceType %>"></asp:Label></label>
                    <div class="col-sm-3">
                        <asp:TextBox ID="tbxName" runat="server" placeholder="Enter Attendence Type" CssClass="form-control"></asp:TextBox>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <div class="box">
                            <div class="box-body">
                                <asp:Repeater ID="rptAttendenceType" runat="server">
                                    <HeaderTemplate>
                                        <table id="example1" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Application,AttendenceType %>"></asp:Label></th>
                                                    <th class="action">
