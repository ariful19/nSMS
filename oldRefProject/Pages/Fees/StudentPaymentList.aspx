<%@ Page Title="<%$ Resources:Application,StudentPaymentList %>" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="StudentPaymentList.aspx.cs" Inherits="Pages_Fees_StudentPaymentList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
     <div class="padding-bottom-15">
                <asp:RadioButtonList ID="rdbList" runat="server" ClientIDMode="Static" RepeatColumns="3" CssClass="form-control FormatRadioButtonList">
                    <asp:ListItem Value="1" Text="Details" Selected="True"></asp:ListItem>
                    <asp:ListItem Value="2" Text="Summary"></asp:ListItem>                   
                </asp:RadioButtonList>
            </div>
    <div class=''>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4">
                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Application,Campus %>"></asp:Label>
                                </label>
                                <div class="col-sm-6">
                                    <asp:DropDownList ID="ddlCampus" DataTextField="CampusName" DataValueField="Id" runat="server" CssClass="form-control dropdown"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4">
                                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:Application,Class %>"></asp:Label></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <asp:DropDownList ID="ddlReceivedBy" DataTextField="UserName" DataValueField="UserName" runat="server" CssClass="form-control dropdown"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <asp:Repeater ID="rptCollector" runat="server">
                            <HeaderTemplate>
                                <table id="example3" class="table table-bordered table-hover">
                                    <thead>
                                        <tr style="color: maroon; font: bold 12px arial,verdana;">
                            ...
                            <ItemTemplate>
                                <tr style="color: orangered; font: bold 11px arial,verdana;">
                                    <td class="text-center"><%#Eval("Name") %></td>
                                    <td class="text-center"><%#Eval("Received") %></td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
                                </tbody>
                            <tbody>
                                <tr style="color: blueviolet; font: bold 12px arial,verdana;">
        ...
        <div class="col-sm-12">
            <div class=''>
                ...
                <div class="panel-body">
                    <asp:Repeater ID="rptHistory" runat="server">
                        <HeaderTemplate>
                            <table id="example1" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th class="text-center" hidden>Bill No</th>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td class="text-center" hidden><%#Eval("ClassId") %></td>
                    ...
                    <asp:Repeater ID="rptTypewiseCollection" runat="server">
                        <HeaderTemplate>
                        ...
                        <FooterTemplate>
                            ...
                            <tbody>
                                <tr>
                                    <td></td>
                                    <td class="text-right"><asp:Label ID="Label3" runat="server" Text="Total Received: " Font-Bold="true"></asp:Label></td>                                 
                                    <td class="text-center">                                        
                                        <asp:Label ID="lblTotal" runat="server" ClientIDMode="Static" Text="0.00" Font-Bold="true"></asp:Label>
                                    </td>                                  
                                </tr>
