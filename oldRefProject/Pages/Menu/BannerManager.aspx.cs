...
public partial class Pages_Menu_BannerManager : BasePage
{
    ...
    protected void BindDataList()
    {
        ...
        var lstImage = gImage.GetData("Banner");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (ValidImage(fileuploadimages) == true)
        {
           ...
           // image.Save(string.Concat(MediumImagePath), ImageCodecInfo.GetImageEncoders()[1], encoderParameters);
            ...
            gallaryImage.ImagePath = "../Images/Banner/" + imgPer;
